import type { NetworkPolicyRule, SandboxCreateOptions } from "#compiled/@vercel/sandbox/index.js";
    ...
    return {
      ...
      createOptions:
        authoredPolicy === undefined
          ? createOptions
          : { ...createOptions, networkPolicy: authoredPolicy as SandboxNetworkPolicy },
    };
  }
